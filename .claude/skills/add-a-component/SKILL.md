...
Do not add a tier, a pattern or a second documentation format. A component is anything that renders under `packages/components/src/components/`; composing several is not a different kind of thing.
